...
| `components/SettingsDialog.tsx` | provider、Persona Pack zip 导入、Web Search、MCP server、OCR 模型源/下载进度/缺模型引导、语音、WebDAV、权限、记忆审计和 Context 可视化设置，以及 Provider/Web Search/WebDAV 连接测试 |
